...
| 1.4 | _pending — tag once committed_ | An append-only Trajectory log makes the Agent Loop's reasoning inspectable, via a debug endpoint and a small viewer page | [story-1.4.md](./story-1.4.md) |
